...
import com.pp.netty.util.internal.EmptyArrays;
...
import static com.pp.netty.util.ResourceLeakDetector.Level.ADVANCED;
import static com.pp.netty.util.ResourceLeakDetector.Level.PARANOID;
import static com.pp.netty.util.internal.StringUtil.*;
...
public class ResourceLeakDetector<T> {
    ...
    */
    ...
    private DefaultResourceLeak track0(T obj) {
        ...
        if (level.ordinal() < PARANOID.ordinal()) {
    ...
    protected void reportUntracedLeak(String resourceType) {
        logger.error("LEAK: {}.release() was not called before it's garbage-collected. " +
                        ...
                        "See https://netty.io/wiki/reference-counted-objects.html for more information.",
                resourceType, PROP_LEVEL, ADVANCED.name().toLowerCase(), simpleClassName(this));
    }
