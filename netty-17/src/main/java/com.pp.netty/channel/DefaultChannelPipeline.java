...
/**
 * @Author: PP-jessica
 * @Description:默认的ChannelPipeline实现类,该类引入了很多方法
 */
public class DefaultChannelPipeline implements ChannelPipeline{
    ...
    /**
     * @Author: PP-jessica
     * @Description:这里就把FastThreadLocal引入了
     */
    ...
    /**
     * @Author: PP-jessica
     * @Description:estimatorHandle对象的原子更新器，这个对象就是用来计算要发送的消息的大小的，其实就是ByteBuf的大小
    ...
    /**
     * @Author: PP-jessica
     * @Description:新添加的方法，得到一个处理器，这个处理器可以计算要发送的消息的大小
     */
    ...
    /**
     * @Author: PP-jessica
     * @Description:检测内存泄露的方法,这里实际上会根据msg属于哪种类型的ByteBuf，然后再决定是否记录调用轨迹
     */
